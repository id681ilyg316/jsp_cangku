	...
	*/
	public void open() 
	{
		 String driver = "com.mysql.cj.jdbc.Driver"; 
		    ...
		    String url = "jdbc:mysql://www.icodedock.com:3306/cangku?useSSL=false&serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8";

		    // MySQL配置时的用户名
		    String user = "cangku"; 

		    // MySQL配置时的密码
		    String password = "cangku"; 
