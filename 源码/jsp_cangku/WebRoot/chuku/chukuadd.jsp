...
<form name="form" action="" >
  ...
  <tr>
    <td height="30" background="../images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">添加出库</div></td>
  </tr>
  <tr>
 ...
 <td colspan="2" class="td"><input name="cksj" placeholder="输入出库时间"  type="text" value="<%=StaticMethod.getStringDate()%>" /> </td>
 </tr>
