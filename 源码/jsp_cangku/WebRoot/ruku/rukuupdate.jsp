...
<form name="form" action="" >
  ...
  <tr>
    <td height="30" background="../images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">修改入库</div></td>
  </tr>
  <tr>
...
<td colspan="2" class="td" ><input type="text"  style="FONT-SIZE: 12px; WIDTH: 300px"  placeholder="输入入库时间"  name=rksj value="<%=rksj%>"></td>
</tr>
